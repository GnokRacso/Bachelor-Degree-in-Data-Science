...
public class ActivityAccountSettingBindingImpl extends ActivityAccountSettingBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.accountSettingsToolbar, 1);
        sViewsWithIds.put(R.id.accountSettingTitle, 2);
        sViewsWithIds.put(R.id.saveButton, 3);
        sViewsWithIds.put(R.id.profilePicture, 4);
        sViewsWithIds.put(R.id.changeProfilePic, 5);
        sViewsWithIds.put(R.id.userFullNameDisplay, 6);
        sViewsWithIds.put(R.id.userNameForChange, 7);
        sViewsWithIds.put(R.id.emailAddressForChange, 8);
        sViewsWithIds.put(R.id.accountPassword, 9);
        sViewsWithIds.put(R.id.changePasswordButton, 10);
