...
public class ActivityHomeBindingImpl extends ActivityHomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.homePageToolbar, 1);
        sViewsWithIds.put(R.id.mrFarmerLogo, 2);
        sViewsWithIds.put(R.id.bottom_navigation, 3);
        sViewsWithIds.put(R.id.groceryBackGround, 4);
        sViewsWithIds.put(R.id.deliveryDetails, 5);
        sViewsWithIds.put(R.id.navView, 6);
    }
    // views
    // variables
    // values
